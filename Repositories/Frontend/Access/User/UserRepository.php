...
namespace Modules\Users\Repositories\Frontend\Access\User;
...
use Modules\Users\Models\Access\User\SocialLogin;
use Modules\Users\Events\Frontend\Auth\UserConfirmed;
    ...
    public function updateProfile($id, $input)
    {
        ...
        if ($user->canChangeEmail()) {
            ...
            if ($user->email != $input['email']) {
                ...
                if ($this->findByEmail($input['username'])) {
                    throw new GeneralException(trans('exceptions.frontend.auth.username_taken'));
                }
                //Emails have to be unique
