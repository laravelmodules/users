...
namespace Modules\Users\Models\Access\User\Traits\Attribute;
...
trait UserAttribute
{
    ...
    {
        /**
         * If Auth user is not 'Administrator'
         *              and is not this user
         *              and the this user
         *                      has Administrator Role
         *                      or has Executive Role
         * Only can see 'Show' button
         */
        if (!access_can($this)) {
